...
Frontier uses 2 object types: :class:`Request <crawlfrontier.core.models.Request>`
and :class:`Response <crawlfrontier.core.models.Response>`. They are used to represent crawling HTTP requests and
...
.. autoclass:: crawlfrontier.core.models.Request
    :members:
...
.. autoclass:: crawlfrontier.core.models.Response
    :members:
...
By default, Crawl Frontier activates the :ref:`fingerprint middleware <frontier-url-fingerprint-middleware>` to
generate a unique fingerprint calculated from the :attr:`Request.url <crawlfrontier.core.models.Request.url>`
and :attr:`Response.url <crawlfrontier.core.models.Response.url>` fields, which is added to the
:attr:`Request.meta <crawlfrontier.core.models.Request.meta>` and
:attr:`Response.meta <crawlfrontier.core.models.Response.meta>` fields respectively. You can use
this middleware or implement your own method to manage frontier objects identification.

An example of a generated fingerprint for a :class:`Request <crawlfrontier.core.models.Request>` object::
...
:attr:`Request.meta <crawlfrontier.core.models.Request.meta>` and
:attr:`Response.meta <crawlfrontier.core.models.Response.meta>` fields.
