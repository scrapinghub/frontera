...
class FrontierManager(object):
    ...
    def get_next_requests(self, info, max_next_requests=0):
        """
        ...
        :param dict info: A hint from downloading facility to the backend.
        ...
        # get next requests
        next_requests = self.backend.get_next_requests(max_next_requests, info=info)
